...
def build_extract_customer_name_prompt(
    ...
    return (
        ...
        "- nombre=null si el mensaje es solo un saludo o frase social "
        "(hola, buenos dias, buenas tardes, buenas noches, que tal, como estas) "
        "o una peticion generica de informacion sin nombre "
        "(quiero mas informacion, quiero informacion, necesito informacion).\n"
        ...
        "- is_refusal=true tambien si responde con un saludo o peticion generica de informacion "
        "en lugar de dar su nombre.\n"
        "- No inventes nombres que el usuario no haya dicho; no conviertas modelos de auto, "
        "marcas, saludos ni frases comerciales en nombres (ej. 'precio del dzire' NO es el nombre "
        "'Precio Del Dzire'; 'Hola' NO es el nombre 'Hola'; "
        "'Quiero mas informacion' NO es el nombre 'Quiero Mas Informacion').\n"
        "Ejemplos:\n"
        "- 'Hola' -> nombre=null, is_refusal=true, mensaje_restante='Hola'\n"
        "- 'Buenos dias' -> nombre=null, is_refusal=true, mensaje_restante='Buenos dias'\n"
        "- 'Hola buenos dias' -> nombre=null, is_refusal=true, mensaje_restante='Hola buenos dias'\n"
        "- 'Quiero mas informacion' -> nombre=null, is_refusal=true, "
        "mensaje_restante='Quiero mas informacion'\n"
