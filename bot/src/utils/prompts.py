...
def build_extract_customer_name_prompt(
    ...
    return (
        ...
        "precio/costo de un vehiculo o modelo, busqueda de autos, financiamiento, promociones, "
        "FAQ del negocio, o cualquier peticion sobre el inventario "
        "(ej. 'precio del dzire', 'cuanto cuesta el swift', 'quiero ver modelos', "
...
def build_financing_detail_escalation_prompt(
    *,
    ...
    return (
        ...
        "- Pregunta tasa o plazo GENERICO de planes publicados sin pedir calculo personalizado "
        "(ej. 'cuales son las tasas', 'que plazos manejan').\n"
