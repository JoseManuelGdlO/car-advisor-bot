...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    if (!(await hasIndex("business_profiles", "idx_business_profiles_owner"))) {
      await queryInterface.addIndex("business_profiles", ["owner_user_id"], { name: "idx_business_profiles_owner" });
    }
    if (!(await hasFk("business_profiles", "fk_business_profiles_owner_user"))) {
    ...
    if (!(await tableExists("channel_integrations"))) {
    ...
    if (!(await hasIndex("channel_integrations", "idx_channel_integrations_owner"))) {
      await queryInterface.addIndex("channel_integrations", ["owner_user_id"], { name: "idx_channel_integrations_owner" });
    }
    if (!(await hasFk("channel_integrations", "fk_channel_integrations_owner_user"))) {
    ...
    if (!(await hasIndex("channel_integrations", "uniq_channel_integrations_owner_channel_provider"))) {
    ...
    if (!(await tableExists("channel_credentials"))) {
    ...
    if (!(await hasFk("channel_credentials", "fk_channel_credentials_integration"))) {
      await queryInterface.addConstraint("channel_credentials", {
